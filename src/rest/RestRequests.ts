...
export abstract class RestRequests {
    ...
    public async getGlobalApplicationCommands(
        ...
        query: DiscordTypes.RESTGetAPIApplicationCommandsQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIApplicationCommandsResult> {
    ...
    public async createGlobalApplicationCommand(
        applicationId: Snowflake,
        body: DiscordTypes.RESTPostAPIApplicationCommandsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIApplicationCommandsResult> {
    ...
    public async getGlobalApplicationCommand(
        ...
        commandId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIApplicationCommandResult> {
    ...
    public async editGlobalApplicationCommand(
        applicationId: Snowflake,
        commandId: Snowflake,
        body: DiscordTypes.RESTPatchAPIApplicationCommandJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIApplicationCommandResult> {
    ...
    public async bulkOverwriteGlobalApplicationCommands(
        applicationId: Snowflake,
        body: DiscordTypes.RESTPutAPIApplicationCommandsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIApplicationCommandsResult> {
    ...
    public async getGuildApplicationCommands(
        applicationId: Snowflake,
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIApplicationGuildCommandsQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIApplicationGuildCommandsResult> {
    ...
    public async createGuildApplicationCommand(
        applicationId: Snowflake,
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIApplicationGuildCommandsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIApplicationGuildCommandsResult> {
    ...
    public async getGuildApplicationCommand(
        ...
        commandId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIApplicationGuildCommandResult> {
    ...
    public async editGuildApplicationCommand(
        ...
        guildId: Snowflake,
        commandId: Snowflake,
        body: DiscordTypes.RESTPatchAPIApplicationGuildCommandJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIApplicationGuildCommandResult> {
    ...
    public async bulkOverwriteGuildApplicationCommands(
        applicationId: Snowflake,
        guildId: Snowflake,
        body: DiscordTypes.RESTPutAPIApplicationGuildCommandsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIApplicationGuildCommandsResult> {
    ...
    public async getGuildApplicationCommandPermissions(
        ...
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildApplicationCommandsPermissionsResult> {
        return await this.request(
            `GET`,
    ...
    public async getApplicationCommandPermissions(
        ...
        commandId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIApplicationCommandPermissionsResult> {
        return await this.request(
            `GET`,
    ...
    public async editApplicationCommandPermissions(
        ...
        guildId: Snowflake,
        commandId: Snowflake,
        body: DiscordTypes.RESTPutAPIApplicationCommandPermissionsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIApplicationCommandPermissionsResult> {
        return await this.request(
            `PUT`,
            `/applications/${applicationId}/guilds/${guildId}/commands/${commandId}/permissions`,
            {
    ...
    public async createInteractionResponse(
        ...
        body: DiscordTypes.RESTPostAPIInteractionCallbackJSONBody | FormData,
        options?: RestRequestOptions,
    ): Promise<never> {
    ...
    public async getOriginalInteractionResponse(
        ...
        interactionToken: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIInteractionOriginalResponseResult> {
    ...
    public async editOriginalInteractionResponse(
        applicationId: Snowflake,
        interactionToken: string,
        body: DiscordTypes.RESTPatchAPIInteractionOriginalResponseJSONBody | FormData,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIInteractionOriginalResponseResult> {
    ...
    public async deleteOriginalInteractionResponse(
        ...
        interactionToken: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIInteractionOriginalResponseResult> {
        return (await this.request(
            `DELETE`,
    ...
    public async createFollowupMessage(
        applicationId: Snowflake,
        interactionToken: string,
        body: DiscordTypes.RESTPostAPIInteractionFollowupJSONBody | FormData,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIInteractionFollowupResult> {
    ...
    public async getFollowupMessage(
        ...
        messageId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIInteractionFollowupResult> {
        return await this.request(
            `GET`,
    ...
    public async editFollowupMessage(
        ...
        interactionToken: string,
        messageId: Snowflake,
        body: DiscordTypes.RESTPatchAPIInteractionFollowupJSONBody | FormData,
        options?: RestRequestOptions,
    ...
    public async deleteFollowupMessage(
        ...
        messageId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIInteractionFollowupResult> {
        return (await this.request(
            `DELETE`,
            `/webhooks/${applicationId}/${interactionToken}/messages/${messageId}`,
            options,
    ...
    public async getGuildAuditLog(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIAuditLogQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIAuditLogResult> {
     ...
     */
    public async listAutoModerationRulesForGuild(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIAutoModerationRulesResult> {
    ...
    public async getAutoModerationRule(
        ...
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIAutoModerationRuleResult> {
    ...
    public async createAutoModerationRule(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIAutoModerationRuleJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIAutoModerationRuleResult> {
    ...
    public async modifyAutoModerationRule(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIAutoModerationRuleResult> {
    ...
    public async deleteAutoModerationRule(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIAutoModerationRuleResult> {
        return (await this.request(`PATCH`, `/guilds/${guildId}/auto-moderation/rules/${autoModerationRuleId}`, {
            reason,
            ...options,
        })) as never;
    ...
    public async getChannel(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelResult> {
    ...
    public async modifyChannel(
        channelId: Snowflake,
        body: DiscordTypes.RESTPatchAPIChannelJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIChannelResult> {
    ...
    public async deleteChannel(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelResult> {
    ...
    public async getChannelMessages(
        channelId: Snowflake,
        query: DiscordTypes.RESTGetAPIChannelMessagesQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelMessagesResult> {
    ...
    public async getChannelMessage(
        ...
        messageId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelMessageResult> {
    ...
    public async createMessage(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelMessageJSONBody | FormData,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelMessageResult> {
    ...
    public async crosspostMessage(
        ...
        messageId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelMessageCrosspostResult> {
    ...
    public async createReaction(
        ...
        emoji: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIChannelMessageReactionResult> {
        return (await this.request(
            `PUT`,
    ...
    public async deleteOwnReaction(
        ...
        emoji: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelMessageOwnReaction> {
        return (await this.request(
            `DELETE`,
            `/channels/${channelId}/messages/${messageId}/reactions/${emoji}/@me`,
            options,
    ...
    public async deleteUserReaction(
        ...
        userId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelMessageUserReactionResult> {
        return (await this.request(
            `DELETE`,
    ...
    public async getReactions(
        ...
        messageId: Snowflake,
        emoji: string,
        query: DiscordTypes.RESTGetAPIChannelMessageReactionUsersQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelMessageReactionUsersResult> {
    ...
    public async deleteAllReactions(
        ...
        messageId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelAllMessageReactionsResult> {
        return (await this.request(
            `DELETE`,
    ...
    public async deleteAllReactionsForEmoji(
        ...
        emoji: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelMessageReactionResult> {
        return (await this.request(
            `DELETE`,
    ...
    public async editMessage(
        channelId: Snowflake,
        messageId: Snowflake,
        body: DiscordTypes.RESTPatchAPIChannelMessageJSONBody | FormData,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIChannelMessageResult> {
    ...
    public async deleteMessage(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelMessageResult> {
    ...
    public async bulkDeleteMessages(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelMessagesBulkDeleteJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelMessagesBulkDeleteResult> {
    ...
    public async editChannelPermissions(
        ...
        body: DiscordTypes.RESTPutAPIChannelPermissionJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIChannelPermissionResult> {
    ...
    public async getChannelInvites(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelInvitesResult> {
    ...
    public async createChannelInvite(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelInviteJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelInviteResult> {
    ...
    public async deleteChannelPermission(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelPermissionResult> {
    ...
    public async followNewsChannel(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelFollowersJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelFollowersResult> {
    ...
    public async triggerTypingIndicator(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelTypingResult> {
    ...
    public async getPinnedMessages(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelPinsResult> {
    ...
    public async pinMessage(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIChannelPinResult> {
    ...
    public async unpinMessage(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelPinResult> {
    ...
    public async groupDMAddRecipient(
        channelId: Snowflake,
        userId: Snowflake,
        body: DiscordTypes.RESTPutAPIChannelRecipientJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIChannelRecipientResult> {
    ...
    public async groupDMRemoveRecipient(
        ...
        userId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelRecipientResult> {
    ...
    public async startThreadFromMessage(
        channelId: Snowflake,
        messageId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelMessagesThreadsJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelMessagesThreadsResult> {
    ...
    public async startThreadWithoutMessage(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelThreadsJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelThreadsResult> {
    ...
    public async startThreadInForumChannel(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildForumThreadsJSONBody | FormData,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelThreadsResult> {
        return await this.request(`POST`, `/channels/${channelId}/threads`, {
    ...
    public async joinThread(
        threadId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIChannelThreadMembersResult> {
    ...
    public async leaveThread(
        threadId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIChannelThreadMembersResult> {
    ...
    public async listThreadMembers(
        threadId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelThreadMembersResult> {
    ...
    public async listPublicArchivedThreads(
        channelId: Snowflake,
        query: DiscordTypes.RESTGetAPIChannelThreadsArchivedQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelUsersThreadsArchivedResult> {
    ...
    public async listGuildEmojis(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildEmojisResult> {
    ...
    public async getGuildEmoji(
        ...
        emoji: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildEmojiResult> {
    ...
    public async createGuildEmoji(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildEmojiJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildEmojiResult> {
    ...
    public async modifyGuildEmoji(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildEmojiJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildEmojiResult> {
    ...
    public async deleteGuildEmoji(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildEmojiResult> {
    ...
    public async createGuild(
        body: DiscordTypes.RESTPostAPIGuildsJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildsResult> {
    ...
    public async getGuild(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildResult> {
    ...
    public async getGuildPreview(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildPreviewResult> {
    ...
    public async modifyGuild(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildResult> {
    ...
    public async deleteGuild(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildResult> {
    ...
    public async getGuildChannels(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildChannelsResult> {
    ...
    public async createGuildChannel(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildChannelJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildChannelResult> {
    ...
    public async modifyGuildChannelPositions(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildChannelPositionsJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildChannelPositionsResult> {
    ...
    public async listActiveThreads(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildThreadsResult> {
    ...
    public async getGuildMember(
        ...
        userId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildMemberResult> {
    ...
    public async listGuildMembers(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildMembersQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildMembersResult> {
    ...
    public async searchGuildMembers(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildMembersSearchQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildMembersSearchResult> {
    ...
    public async addGuildMember(
        guildId: Snowflake,
        userId: Snowflake,
        body: DiscordTypes.RESTPutAPIGuildMemberJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIGuildMemberResult> {
    ...
    public async modifyGuildMember(
        guildId: Snowflake,
        userId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildMemberJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildMemberResult> {
    ...
    public async modifyCurrentMember(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPICurrentGuildMemberJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildMemberResult> {
    ...
    public async addGuildMemberRole(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIGuildMemberRoleResult> {
    ...
    public async removeGuildMemberRole(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildMemberRoleResult> {
    ...
    public async removeGuildMember(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildMemberResult> {
    ...
    public async getGuildBans(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildBansQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildBansResult> {
    ...
    public async getGuildBan(
        ...
        userId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildBanResult> {
    ...
    public async createGuildBan(
        guildId: Snowflake,
        userId: Snowflake,
        body: DiscordTypes.RESTPutAPIGuildBanJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPutAPIGuildBanResult> {
    ...
    public async removeGuildBan(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildBanResult> {
    ...
    public async getGuildRoles(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildRolesResult> {
    ...
    public async createGuildRole(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildRoleJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildRoleResult> {
     ...
     */
    public async modifyGuildRolePositions(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildRolePositionsJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildRolePositionsResult> {
    ...
    public async modifyGuildRole(
        guildId: Snowflake,
        roleId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildRoleJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildRoleResult> {
     ...
     */
    public async modifyGuildMFALevel(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildsMFAJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildsMFAResult> {
    ...
    public async deleteGuildRole(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildRoleResult> {
    ...
    public async getGuildPruneCount(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildPruneCountQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildPruneCountResult> {
    ...
    public async beginGuildPrune(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildPruneJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildPruneResult> {
    ...
    public async getGuildVoiceRegions(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildVoiceRegionsResult> {
    ...
    public async getGuildInvites(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildInvitesResult> {
    ...
    public async getGuildIntegrations(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildIntegrationsResult> {
    ...
    public async deleteGuildIntegration(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildIntegrationResult> {
    ...
    public async getGuildWidgetSettings(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildWidgetSettingsResult> {
    ...
    public async modifyGuildWidget(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildWidgetSettingsResult> {
    ...
    public async getGuildWidget(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildWidgetJSONResult> {
    ...
    public async getGuildVanityURL(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildVanityUrlResult> {
    ...
    public async getGuildWelcomeScreen(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildWelcomeScreenResult> {
    ...
    public async modifyGuildWelcomeScreen(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildWelcomeScreenJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildWelcomeScreenResult> {
    ...
    public async modifyCurrentUserVoiceState(
        guildId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildVoiceStateCurrentMemberJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildVoiceStateCurrentMemberResult> {
    ...
    public async modifyUserVoiceState(
        guildId: Snowflake,
        userId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildVoiceStateUserJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildVoiceStateUserResult> {
     ...
     */
    public async listScheduledEventsForGuild(
        guildId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildScheduledEventsQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildScheduledEventsResult> {
    ...
    public async createGuildScheduledEvent(
        guildId: Snowflake,
        body: DiscordTypes.RESTPostAPIGuildScheduledEventJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildScheduledEventResult> {
    ...
    public async getGuildScheduledEvent(
        guildId: Snowflake,
        eventId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildScheduledEventQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildScheduledEventResult> {
     ...
     */
    public async modifyGuildScheduledEvent(
        guildId: Snowflake,
        eventId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildScheduledEventJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildScheduledEventResult> {
    ...
    public async deleteGuildScheduledEvent(
        ...
        eventId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildScheduledEventResult> {
     ...
     */
    public async getGuildScheduledEventUsers(
        guildId: Snowflake,
        eventId: Snowflake,
        query: DiscordTypes.RESTGetAPIGuildScheduledEventUsersQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildScheduledEventUsersResult> {
    ...
    public async getInvite(
        inviteCode: string,
        query: DiscordTypes.RESTGetAPIInviteQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIInviteResult> {
    ...
    public async deleteInvite(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIInviteResult> {
    ...
    public async createStageInstance(
        body: DiscordTypes.RESTPostAPIStageInstanceJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIStageInstanceResult> {
    ...
    public async getStageInstance(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIStageInstanceResult> {
    ...
    public async modifyStageInstance(
        channelId: Snowflake,
        body: DiscordTypes.RESTPatchAPIStageInstanceJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIStageInstanceResult> {
    ...
    public async deleteStageInstance(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIStageInstanceResult> {
    ...
    public async getSticker(
        stickerId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIStickerResult> {
     ...
     */
    public async listNitroStickerPacks(
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetNitroStickerPacksResult> {
    ...
    public async listGuildStickers(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildStickersResult> {
    ...
    public async getGuildSticker(
        ...
        stickerId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildStickerResult> {
    ...
    public async createGuildSticker(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIGuildStickerResult> {
    ...
    public async modifyGuildSticker(
        guildId: Snowflake,
        stickerId: Snowflake,
        body: DiscordTypes.RESTPatchAPIGuildStickerJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIGuildStickerResult> {
    ...
    public async deleteGuildSticker(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIGuildStickerResult> {
        return (await this.request(`PATCH`, `/guilds/${guildId}/stickers/${stickerId}`, {
            reason,
            ...options,
        })) as never;
     ...
     */
    public async modifyCurrentUser(
        body: DiscordTypes.RESTPatchAPICurrentUserJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPICurrentUserResult> {
    ...
    public async getCurrentUserGuilds(
        query: DiscordTypes.RESTGetAPICurrentUserGuildsQuery,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPICurrentUserGuildsResult> {
    ...
    public async getCurrentUserGuildMember(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetCurrentUserGuildMemberResult> {
    ...
    public async leaveGuild(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPICurrentUserGuildResult> {
    ...
    public async createDM(
        body: DiscordTypes.RESTPostAPICurrentUserCreateDMChannelJSONBody,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPICurrentUserCreateDMChannelResult> {
    ...
    public async getUserConnections(
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPICurrentUserConnectionsResult> {
    ...
    public async createWebhook(
        channelId: Snowflake,
        body: DiscordTypes.RESTPostAPIChannelWebhookJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPostAPIChannelWebhookResult> {
     ...
     */
    public async getChannelWebhooks(
        channelId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIChannelWebhooksResult> {
    ...
    public async getGuildWebhooks(
        guildId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIGuildWebhooksResult> {
    ...
    public async getWebhook(
        webhookId: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIWebhookResult> {
    ...
    public async getWebhookWithToken(
        ...
        token: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIWebhookWithTokenResult> {
    ...
    public async modifyWebhook(
        webhookId: Snowflake,
        body: DiscordTypes.RESTPatchAPIWebhookJSONBody,
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIWebhookResult> {
    ...
    public async modifyWebhookWithToken(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIWebhookWithTokenResult> {
    ...
    public async deleteWebhook(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIWebhookResult> {
    ...
    public async deleteWebhookWithToken(
        ...
        reason?: string,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIWebhookWithTokenResult> {
     ...
     */
    public async executeWebhook<T extends boolean = false>(
        webhookId: Snowflake,
        token: string,
        body: DiscordTypes.RESTPostAPIWebhookWithTokenJSONBody | FormData,
        wait?: T,
        threadId?: Snowflake,
        options?: RestRequestOptions,
    ): Promise<
        T extends true
            ? DiscordTypes.RESTPostAPIWebhookWithTokenWaitResult
            : DiscordTypes.RESTPostAPIWebhookWithTokenResult
    > {
    ...
    public async getWebhookMessage(
        ...
        threadId?: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIWebhookWithTokenMessageResult> {
    ...
    public async editWebhookMessage(
        ...
        token: string,
        messageId: Snowflake,
        body: DiscordTypes.RESTPatchAPIWebhookWithTokenMessageJSONBody | FormData,
        threadId?: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTPatchAPIWebhookWithTokenMessageResult> {
    ...
    public async deleteWebhookMessage(
        ...
        threadId?: Snowflake,
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTDeleteAPIWebhookWithTokenMessageResult> {
    ...
    public async getCurrentBotApplicationInformation(
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIOAuth2CurrentApplicationResult> {
    ...
    public async getCurrentAuthorizationInformation(
        options?: RestRequestOptions,
    ): Promise<DiscordTypes.RESTGetAPIOAuth2CurrentAuthorizationResult> {
